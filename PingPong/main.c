...
int main(void)
{
  ...
  */
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  OPENAMP_check_for_message(); // Poll OpenAMP continuously to check for incoming messages
	  HAL_Delay(1); //Add a 1ms delay to briefly yield CPU time and prevent tight-loop saturation
  }
  /* USER CODE END 3 */
}
